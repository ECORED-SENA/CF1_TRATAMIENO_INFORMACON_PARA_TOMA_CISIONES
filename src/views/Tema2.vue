          ...
          SlyderA(tipo="b").color_slyder-a_botones
            ...
            .row.justify-content-center
              .col-lg-11.marginb-1
                ...
                p.mt-3 Una solución de respaldo puede garantizar que nunca pierda datos o experimente un tiempo de inactividad no deseado que provoque la pérdida de ingresos o la pérdida de clientes. 
        ...
        .col-lg-6
          ImagenInfografica.color-secundario.mb-5(data-aos="fade-up")
            ...
            .tarjeta.color-acento-botones.color_tar-imginfografica-t4.p-3(x="58%" y="40%")
              p <b>Gestión de relaciones con los clientes:</b> estas ayudan a realizar el seguimiento de los clientes potenciales, actuales y anteriores desde la primera interacción a través de embudos de <em>marketing</em> y ventas. También puede proporcionar herramientas para nutrir esas relaciones con los contactos por puntos de datos específicos, como la región o el tipo de producto que compraron. De esa manera, sabrá a quién dirigirse con mensajes de seguimiento para referencias o negocios. 
            ...
            .tarjeta.color-acento-botones.color_tar-imginfografica-t4.p-3(x="58%" y="60%")
              p <b>Plataformas de almacenamiento en la nube:</b> es un sistema de almacenamiento en la nube que permite que los archivos sean accesibles para todos los empleados, sin importar dónde se encuentren. Algunas plataformas son colaborativas, lo que permite editar archivos directamente en tiempo real juntos a través de la nube.
